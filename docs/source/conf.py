...
htmlhelp_basename = 'ansible-role-ansible-doc'
...
latex_documents = [
    (master_doc, 'ansible-role-ansible.tex', 'ansible-role-ansible Documentation',
...
man_pages = [
    (master_doc, 'ansible-role-ansible', 'ansible-role-ansible Documentation',
     [author], 1)
]
